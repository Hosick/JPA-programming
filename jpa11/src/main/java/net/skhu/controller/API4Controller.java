...
public class API4Controller {
    ...
    public Student testUpdate1() {
        ...
        if (student.getName().equals("고은별")) studentRepository2.updateStudentName(2, "Go En Byeol");
        else studentRepository2.updateStudentName(2, "고은별");
    ...
    public Student testUpdate2() {
        Student student = studentRepository2.findById(2).get();
        if (student.getName().equals("고은별")) student.setName("Go En Byeol");
        else student.setName("고은별");
